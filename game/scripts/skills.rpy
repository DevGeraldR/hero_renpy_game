...
label hero_skill:
    ...
    if skill == "Heal":
        call hero_skill_animation from _call_hero_skill_animation
    ...
    if skill == "Punch":
        call hero_skill_animation from _call_hero_skill_animation_1
        if d10 >= 8:
        ...
        call hero_skill_animation from _call_hero_skill_animation_2          
        if d10 >= 9:    
...
label hero_skill_animation:
    ...
    if level == 1:
        ...
        # zorder 100 to show image in front layer
        show hero attack zorder 100 with dissolve:
            xalign 0.7
            yalign 0.7
    ...
    # zorder 1 to give space for enemy attack
    show hero stand zorder 1 with dissolve:
        xalign 0.2
        yalign 0.7
...
label enemy_attack:
    ...
    if level == 1:    
        ...
        if d20 >= 21:
            call enemy_attack_animation from _call_enemy_attack_animation                                                                                
            $ hero.hp -= d10
        ...
        # When healing
            ...
            call enemy_attack_animation from _call_enemy_attack_animation_1                                                                                
            $ hero.hp -= d4
        ...
        if enemy == "enemy_2_1":      
            ...
            if d20 >= 19:
                call enemy_attack_animation from _call_enemy_attack_animation_2                                                                                
                $ hero.hp -= d10
                ...
                call enemy_attack_animation from _call_enemy_attack_animation_3                                                                                
                $ hero.hp -= d4

        elif enemy == "enemy_2_2":            

            if d20 >= 19:
                call enemy_attack_animation from _call_enemy_attack_animation_4                                                                                
                $ hero.hp -= d10
            elif d20 <=2:
                ...
                call enemy_attack_animation from _call_enemy_attack_animation_5                                                                                
                $ hero.hp -= d4

        elif enemy == "enemy_3_1":            

            if d20 >= 19:
                call enemy_attack_animation from _call_enemy_attack_animation_6                                                                                
                $ hero.hp -= d10
            elif d20 <=2:
                ...
                call enemy_attack_animation from _call_enemy_attack_animation_7                                                                                
                $ hero.hp -= d4

        elif enemy == "enemy_3_2":            

            if d20 >= 19:
                call enemy_attack_animation from _call_enemy_attack_animation_8                                                                                
                $ hero.hp -= d10
            elif d20 <=2:
                ...
                call enemy_attack_animation from _call_enemy_attack_animation_9                                                                                
                $ hero.hp -= d4

        elif enemy == "enemy_3_3":            

            if d20 >= 19:
                call enemy_attack_animation from _call_enemy_attack_animation_10                                                                                
                $ hero.hp -= d10
            elif d20 <=2:
                ...
                call enemy_attack_animation from _call_enemy_attack_animation_11                                                                                
                $ hero.hp -= d4
...
label enemy_attack_animation:
    ...
    # zorder 10 to display image in front layer

    if enemy == "enemy_1":

        show enemy_1 attack zorder 10 with dissolve:
            xalign 0.3
            yalign 0.7
        ...
        show enemy_2_1 attack zorder 10 with dissolve:
            xalign 0.3
            yalign 0.7
        ...
        show enemy_2_2 attack zorder 10 with dissolve:
            xalign 0.3
            yalign 0.7
        ...
        show enemy_3_1 attack zorder 10 with dissolve:
            xalign 0.3
            yalign 0.7
        ...
        show enemy_3_2 attack zorder 10 with dissolve:
            xalign 0.3
            yalign 0.7
